...
const Category3 = () => {
  const [earphone, setEarphone] = React.useState(false);
  ...
  return (
    <>
      ...
      {!earphone && !watch && !laptop && (
        <div>
          <div className="py-8 bg-white dark:bg-gray-900 dark:text-white duration-200 overflow-hidden">
